...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    @Test
    @DisplayName("looking for intersection bugs")
    public void hasNoIntersection() {
        InMemoryTaskManager manager = new InMemoryTaskManager();
        manager.addNewTask(new Task("","", Status.NEW,  Duration.ofMinutes(30), LocalDateTime.of(2002, Month.AUGUST, 1,12,0)));
        manager.addNewTask(new Task("","", Status.NEW,  Duration.ofMinutes(30), LocalDateTime.of(2002, Month.AUGUST, 1,11,0)));
        manager.addNewTask(new Task("","", Status.NEW,  Duration.ofMinutes(30), LocalDateTime.of(2002, Month.AUGUST, 1,12,20)));
        manager.addNewTask(new Task("","", Status.NEW,  Duration.ofMinutes(30), LocalDateTime.of(2002, Month.AUGUST, 1,11,50)));
        manager.addNewTask(new Task("","", Status.NEW,  Duration.ofMinutes(12), LocalDateTime.of(2002, Month.AUGUST, 1,12,12)));
